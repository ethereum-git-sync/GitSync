...
then
	...
	do
		...
		curl https://api.github.com/repos/${1}/issues/$LINE > /home/ubuntu/issue/${1}/"$LINE".json
		curl https://api.github.com/repos/${1}/issues/$LINE/comments >> /home/ubuntu/issue/${1}/"$LINE".json
	done
else
